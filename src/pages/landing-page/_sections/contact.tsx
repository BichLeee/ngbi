...
export const Contact = () => {
        ...
        () => {
            gsap.fromTo(
                ...
                { y: 50, opacity: 0 },
                {
                    ...
                    duration: 1.1,
                    ease: "power3.out",
                    scrollTrigger: { trigger: secRef.current, start: "top 84%", toggleActions: "play none none reverse" },
                },
            );
            gsap.fromTo(
                ".contact-btn",
    ...
    return (
        <Section
            ...
            preHeading="Get in"
            headingProps={{ style: { fontSize: "clamp(2.2rem, 6vw, 6rem)" }, className: "ct-heading" }}
        >
            <ContactIntro>
